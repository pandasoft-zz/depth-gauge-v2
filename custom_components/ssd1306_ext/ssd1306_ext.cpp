#include "ssd1306_ext.h"
#include "esphome/core/log.h"

namespace esphome {
namespace ssd1306_ext {

static const char *TAG = "ssd1306_ext";

void EXTSSD1306::setup() {
...
void EXTSSD1306::turnOn(){
  ESP_LOGD(TAG, "TurnOn call");
  this->command(0xAF);
}

void EXTSSD1306::turnOff(){
  ESP_LOGD(TAG, "TurnOFF call");
  this->command(0xAE);
}

void EXTSSD1306::command(uint8_t value) { this->write_byte(0x00, value); }
void HOT EXTSSD1306::write_display_data() {
  if (this->is_sh1106_()) {
    uint32_t i = 0;
